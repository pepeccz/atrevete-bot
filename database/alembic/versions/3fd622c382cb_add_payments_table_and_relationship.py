...
down_revision: str | None = 'dc561f2b086e'
...
def upgrade() -> None:
    ...
    sa.Column('amount', sa.Numeric(precision=10, scale=2), nullable=False, comment='Payment amount in euros (e.g., 15.00 for 15€ deposit)'),
