...
class TestSlotTodayContent:
    def test_a1_slot_present_in_rendered_string(self):
        ...
        now_utc = datetime(2026, 4, 27, 12, 0, 0, tzinfo=timezone.utc)
    ...
    def test_a4_dst_winter_cet(self):
        ...
        now_utc = datetime(2026, 1, 5, 11, 0, 0, tzinfo=timezone.utc)
        result = _render_today(now_utc)
    ...
    def test_tuesday_weekday(self):
        now_utc = datetime(2026, 4, 28, 12, 0, 0, tzinfo=timezone.utc)  # Tuesday
        result = _render_today(now_utc)
