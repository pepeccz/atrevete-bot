...
Si la longitud no está clara, pregunta antes de elegir variante. Esta tabla es la fuente única de verdad. Los demás archivos deben referenciar esta sección por nombre, no repetir el mapeo.

---

## Frases de fecha vaga

Cuando el cliente usa alguna de estas frases sin día concreto, usa `get_next_available_options`:

- "lo antes posible" · "esta semana" · "cuando puedas" · "lo primero que haya" · "cuanto antes" · "cualquier día" · "pronto"
...
`booking_fsm.md § STYLIST_REQUIRED`. Presenta primero los nombres reales y al final
