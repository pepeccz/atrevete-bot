...
| `update_booking` devolvió `next_step` con "Audiencia ambigua" o `missing` incluye "audiencia" | Preguntar al cliente qué variante (señora, caballero, niño/a, bebé) en lenguaje natural antes de llamar nuevamente |
